...
<body>
	...
	<div class="container">
		...
		<form action="insert" method="POST" class="form">
			...
			<div class="input-box">
				<label><b>E-mail</b></label> <input type="Email" name="email"
					placeholder="Enter your E-mail" required><br>
				<br>
			</div>

			<div class="input-box">
				<label><b>Ratings</b></label><br>
				<br>
				<div class="rating">
					<input type="number" name="rating" hidden required> <i
						class='bx bx-star star' style="--i: 0;"></i> <i
				...
				<script src="FeedbackInsert.js"></script>
			</div>

			<div class="input-box">
				<label><b>Message</b></label>
				<textarea name="opinion" cols="50" rows="10"
					placeholder="Your opinion...." required></textarea>
			</div>
