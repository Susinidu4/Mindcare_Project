	...
	<table class="employee-details">
		...
		%>
			<tr align=center>
				...
				<td><a
					href='updateFeedback.jsp?u=<% out.println(rs.getString("id")); %>'
					class="button"><b>Edit</b></a></td>
				<td>
					<form action='deleteFeedback?d=<%=rs.getString("ID")%>'
						method="post">
						<input type="submit" name="delete" value="Delete"
							id="<%=rs.getString("ID")%>" class="button">
					</form>
				</td>
			</tr>
